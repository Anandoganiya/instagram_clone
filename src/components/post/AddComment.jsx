  ...
  return (
    <div className="w-full">
      <form
        action=""
        onSubmit={(e) =>
          inputComment.length >= 1 ? handleCommentForm(e) : e.preventDefault()
        }
        className="w-full flex border justify-between"
      >
        <input
          type="text"
          ref={commentInput}
        ...
        />
        <button
          disabled={inputComment.length < 1}
          className="w-[5rem] bg-gray-100"
        >
          submit
        </button>
      </form>
